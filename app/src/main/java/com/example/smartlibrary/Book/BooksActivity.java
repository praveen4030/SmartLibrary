...
public class BooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookRef = FirebaseDatabase.getInstance().getReference().child("Books").child(category);
        ...
        bookRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    searchPb.setVisibility(View.GONE);
                    Toast.makeText(BooksActivity.this, "No Data Available", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        public void onBindViewHolder(@NonNull SearchAdapter.SearchHolder holder, int position) {
            ...
            holder.issueBt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(BooksActivity.this, IssueActivity.class);
